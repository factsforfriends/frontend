...
var Index = function Index(_ref) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx(_components_PageTitle__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    className: "p-10 shadow rounded list-none bg-orange-100",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10,
    ...
    var id = _ref2.id,
        title = _ref2.title;
    return __jsx("li", {
      className: "rounded border-2 p-4 border-blue-500 hover:border-red-500 my-5",
      key: id,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.33767e91e6fb320cdf82.hot-update.js.map