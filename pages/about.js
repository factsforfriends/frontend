  ...
  return (
    <>
      ...
      <ul>
        ...
        <li><strong>Sebastian</strong>(45) ist seit über 20 Jahren Grafiker in einem kleinen Hamburger Fachverlag. Für das Projekt hat er das Design für die Sharepics sowie das Logo entworfen und das finale Bewerbungsvideo geschnitten.</li>
        <li><strong>Jens</strong> schlägt als Computational Biologist am Max-Planck-Institut für Herz- und Lungenforschung Brücken zwischen Wissenschaft, Datenanalyse und Cloud-Infrastruktur. Für das Projekt hat er das Platform-Development und Content-Team unterstützt.</li>
        <li><strong>Kilian</strong> studiert im dritten Semester Journalistik an der Katholischen Universität Eichstätt-Ingolstadt. Da er privat als Journalist häufig mit Fake-News zu kämpfen hat und diese widerlegen muss, ist ihm das Projekt eine Herzensangelegenheit. Er hat im Content-Bereich mitgewirkt und Texte verfasst und redigiert.</li>
        <li><strong>Katharina</strong> ist gebürtige Hamburgerin und hat mit 18 ihr erstes Unternehmen gegründet. Nach ihrem Masterabschluss in Entrepreneurship und Innovationsmanagement an der Königlichen Technischen Universität Stockholm hat sie ein weiteres Startup gegründet und arbeitet als Head of Brand Marketing und Kommunikation bei einem wachsenden Startup. Bei Facts for Friends hat sie den Design-Thinking Prozess begleitet und das Content Team unterstützt.</li>
        <li><strong>Francisco</strong> promoviert in Mensch-Computer Interaktion an der Universität Stuttgart. Seine Forschung ist an der Augmentierung der menschlichen Wahrnehmung durch digitalen Medien fokussiert. Anhand seines Hintergrund in Elektrotechnik, er versucht die biologische Grenzen der menschlichen Sinne mit wearable Computers zu überschreiten. Er unterstützt das Projekt mit Beiträgen zum Thema UX.</li>
        <li><strong>Tobias</strong> ist Software Entwickler im Frontend-Bereich. Für das Projekt hat er das das Platform-Development Team mit seinen React-Kentnissen unterstützt.</li>
        <li><strong>Nele</strong> studiert im vierten Semester International Management in einem Double Degree. Für das Projekt hat sie das Content-team unterstützt.</li>
      </ul>
    </>
  );
};
