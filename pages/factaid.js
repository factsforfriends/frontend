...
const Contribute = () => {
  return (
    <>
      ...
      >
          <li style={{paddingTop: "15px"}}>
              Ich versuche, ruhig zu bleiben und teile keine Informationen im Affekt. Ich atme dreimal tief durch, bevor ich etwas veröffentliche oder an meine Freund:innen schicke.
          </li>
          <li style={{paddingTop: "15px"}}>
              Ich suche mindestens zwei verlässliche Quellen für die Informationen. Es gibt in solchen Situationen immer wieder Betrüger:innen, die bewusst falsche Informationen verbreiten - auch wenn sie noch so nett klingen.
          </li>
          <li style={{paddingTop: "15px"}}>
          ...
          <li style={{paddingTop: "15px"}}>
              Ich informiere mich bei meiner Gemeinde oder meiner Stadt und deren Behörden über die Lage vor Ort. Viele Kommunen geben auch Telefonnummern an, untern denen man sich informieren und beraten lassen kann. Dieses Angebot kann insbesondere für Angehörige wichtig sein, die keinen Zugang zum Internet haben.
          </li>
          <li style={{paddingTop: "15px"}}>
              Ich hüte mich davor, falsche Versprechen über angebliche Heilmittel zu verbreiten. Wissenschaftler:innen arbeiten mit Hochdruck an Medikamenten gegen das neue Virus, aber die gibt es noch nicht. Amazon hat bereits zahlreiche dubiose Angebote mit angeblichen Heilmitteln verbannt.
          </li>
          <li style={{paddingTop: "15px"}}>
              Ich verbreite keine einseitigen Schuldzuweisungen und gebe diesen auch durch Retweets und Zitate keine Bühne. Das gilt insbesondere auch für <Link href="https://uebermedien.de/45749/corona-und-der-grassierende-virus-der-chinesenfeindlichkeit/">rassistische Äußerungen</Link>.
          </li>
          <li style={{paddingTop: "15px"}}>
      ...
      <ul
        style={{ paddingLeft: "20px", marginTop: "5px" }}
      >
          <li style={{paddingTop: "15px"}}><strong>Kernfakten:</strong> Bei einer Widerlegung solltest Du die Fakten betonen, nicht den Mythos. Präsentiere dabei nur die wichtigen Fakten, um zu vermeiden, dass zu viele Informationen zu einer Überforderung führen. Denn das kann den Mythos noch weiter verfestigen (Overkill-Backfire-Effekt). Informationen, die für Leser:innen einfach zu verstehen sind, werden auch eher als wahr akzeptiert. Deswegen sollte die Sprache einfach gehalten sein. Ein wichtiges Element sind kurze Sätze.</li>
          <li style={{paddingTop: "15px"}}><strong>Explizite Warnungen:</strong> Bevor ein Mythos erwähnt wird, sollten ein Text oder visuelle Hinweise darauf hinweisen, dass die folgenden Informationen falsch sind.</li>
